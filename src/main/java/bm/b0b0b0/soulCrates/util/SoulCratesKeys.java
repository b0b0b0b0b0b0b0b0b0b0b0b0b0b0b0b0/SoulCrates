...
public final class SoulCratesKeys {
    ...
    public static final String MOB_PICK_SESSION = "mob_pick_session";
    ...
    public static NamespacedKey mobPickSession(Plugin plugin) {
        return new NamespacedKey(plugin, MOB_PICK_SESSION);
    }
